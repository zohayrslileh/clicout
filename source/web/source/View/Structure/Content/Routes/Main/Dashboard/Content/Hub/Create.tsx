...
export default function () {
    ...
    return <Container>
        ...
        <div id="right">
            <SearchInput<Country | undefined>
                options={countries.solve}
                onLabel={country => country ? country.name : ""}
                onSearch={keyword => countries.solve.filter(country => new RegExp(keyword, "i").test(country.name))}
                value={country}
