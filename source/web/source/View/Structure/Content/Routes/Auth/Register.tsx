    ...
    return <Card className="m-auto grid gap-2 smooth" style={{ gridTemplateColumns: screen ? "500px auto" : "auto" }}>
        ...
        <div className="grid p-7 py-[45px] gap-10 w-[450px]">
            ...
            <Form className="grid gap-3" onSubmit={registerPromise.safeExecute}>
                ...
                <Checkbox isSelected={registerForm.value.agreeTerms} onValueChange={registerForm.update.agreeTerms} isInvalid={registerIssues.has("agreeTerms")}><Lang>I accept to the</Lang> <Link to="#" className="text-primary"><Lang>terms</Lang></Link> <Lang>and</Lang> <Link to="#" className="text-primary"><Lang>privacy policy</Lang></Link>.</Checkbox>
